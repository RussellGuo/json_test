...
import static com.huaqin.posservices.RemoteMessage.boolean_t.failed;
import static com.huaqin.posservices.RemoteMessage.boolean_t.succeeded;
...
public class PosService2 extends Service {
   ...
   public void startCallback(byte[] obj) {
        ...
        for (int i = 0; i < N; i++) {
            try {
                ...
                mCallbacks.getBroadcastItem(i).serverReport(" Read A Card Success");
