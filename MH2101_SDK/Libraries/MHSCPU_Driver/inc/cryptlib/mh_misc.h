...
#define MH_RET_MISC_INIT             (0x51B649AAUL)
#define MH_RET_MISC_PARAM_ERR        (MH_RET_MISC_INIT + 0x01)
#define MH_RET_MISC_SUCCESS          (MH_RET_MISC_INIT + 0x100)
...
uint32_t MHMEM_Copy(void *pvDst, void *pvSrc, uint32_t u32ByteLen);
