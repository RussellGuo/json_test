...
#define MH_RET_RSA_ERR                       (MH_RET_RSA_INIT + 0x03) 
#define MH_RET_RSA_DFA_LOCK                  (MH_RET_RSA_INIT + 0x04)
#define MH_RET_PRIME_IS_PRIME                (MH_RET_RSA_INIT + 0x05)
#define MH_RET_PRIME_INPUT_PARA_ERR          (MH_RET_RSA_INIT + 0x06)
#define MH_RET_RSA_GCD_ISNOT_ONE             (MH_RET_RSA_INIT + 0x07)
#define MH_RET_PRIME_NOT_ACCEPTABLE          (MH_RET_RSA_INIT + 0x08)
