...
typedef struct
{
    ...
    uint32_t DCMI_DMARequestSize;   /*!< Specifies the DMA Request FIFO SIZE: 1, 2, 4 Words
                                         This parameter can be a value of @ref DCMI_DMARequest_Size */
    uint32_t DCMI_InputMode;        /*!< Specifies the Input Mode: MIPI or DVP.
                                         This parameter can be a value of @ref DCMI_Input_Mode */
} DCMI_InitTypeDef;
