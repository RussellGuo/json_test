...
{ 
	GPIO_DRIVE_8mA   = 0x00,
	GPIO_DRIVE_16mA  = 0x01,
	GPIO_DRIVE_24mA  = 0x02,
	GPIO_DRIVE_32mA  = 0x03,	
}GPIO_DriveTypeDef;
#define IS_GPIO_DRIVE_SEL(DRIVE)	     (((DRIVE) == GPIO_DRIVE_8mA) || \
										  ((DRIVE) == GPIO_DRIVE_16mA) || \
										  ((DRIVE) == GPIO_DRIVE_24mA) || \
										  ((DRIVE) == GPIO_DRIVE_32mA) )


/** 
  * @brief  GPIO Slew Rate definition  
  */
typedef enum
{ 
	GPIO_SLEW_RATE_FAST = 0x00,
	GPIO_SLEW_RATE_SLOW = 0x01,
}GPIO_SlewTypeDef;
#define IS_GPIO_SLEW_RATE(SLEW)	         (((SLEW) == GPIO_SLEW_RATE_FAST) || \
										  ((SLEW) == GPIO_SLEW_RATE_SLOW) )
...
typedef enum
{ 
	GPIO_FUNC_ANA = 0x00,            /* Analog IO */
	GPIO_FUNC_DIG = 0x01,            /* Digital IO */
}GPIO_FuncTypeDef;
#define IS_GPIO_FUNC(FUNC)	             (((FUNC) == GPIO_FUNC_ANA) || \
										  ((FUNC) == GPIO_FUNC_DIG) )
