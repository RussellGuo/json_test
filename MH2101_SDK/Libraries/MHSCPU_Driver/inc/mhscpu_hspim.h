...
#define IS_HSPIM_BAUDRATE_PRESCALER(PRESCALER) 						(((PRESCALER) >= 0x01) && ((PRESCALER) <= 0x10))
...
/** @defgroup HSPIM_interrupts_definition 
  * @{
  */
...
#define IS_HSPIM_CONFIG_IT(IT) 										(((IT) == HSPIM_IT_RX) || ((IT) == HSPIM_IT_TX) || ((IT) == HSPIM_IT_EN))
...
#define IS_HSPIM_GET_IT(IT) 										(((IT) == HSPIM_IT_ID_RXF)	|| ((IT) == HSPIM_IT_ID_RXTF)	|| \
																	((IT) == HSPIM_IT_ID_RXE)	|| ((IT) == HSPIM_IT_ID_TXF)	|| \
																	((IT) == HSPIM_IT_ID_TXE)	|| ((IT) == HSPIM_IT_ID_TXTF))
/**
  * @}
  */
  
/** @defgroup HSPIM_flags_definition 
  * @{
  */
...
#define HSPIM_FLAG_TXOVFERR											((uint32_t)0x0008)
#define HSPIM_FLAG_TXUDFERR											((uint32_t)0x0001)

#define HSPIM_FLAG_RXE												((uint32_t)0x0400)
#define HSPIM_FLAG_RXF												((uint32_t)0x1000)
#define HSPIM_FLAG_RXTF												((uint32_t)0x2000)
#define HSPIM_FLAG_RXOVFERR											((uint32_t)0x0800)
#define HSPIM_FLAG_RXUDFERR											((uint32_t)0x0100)

#define IS_HSPIM_GET_FLAG(FLAG) 									(((FLAG) == HSPIM_FLAG_TXE)     || ((FLAG) == HSPIM_FLAG_TXF)       || \
																	((FLAG) == HSPIM_FLAG_TXTF)     || ((FLAG) == HSPIM_FLAG_TXOVFERR)  || \
																	((FLAG) == HSPIM_FLAG_TXUDFERR) || ((FLAG) == HSPIM_FLAG_RXE)       || \
																	((FLAG) == HSPIM_FLAG_RXF)      || ((FLAG) == HSPIM_FLAG_RXTF)      || \
																	((FLAG) == HSPIM_FLAG_RXOVFERR) || ((FLAG) == HSPIM_FLAG_RXUDFERR)) 
...
void HSPIM_FIFOReset(HSPIM_TypeDef *HSPIx, uint32_t HSPIM_IT);
