...
/** @defgroup HSPIS_RXFIFOFullThreshold 
  * @{
  */
#define HSPIS_RX_FIFO_FULL_THRESHOLD_0		 						((uint32_t)0x0000)
...
#define IS_HSPIS_CONFIG_IT(IT) 										(((IT) == HSPIS_IT_RX) || ((IT) == HSPIS_IT_TX) || ((IT) == HSPIS_IT_EN))
...
#define IS_HSPIS_GET_IT(IT) 										(((IT) == HSPIS_IT_ID_RXF)	|| ((IT) == HSPIS_IT_ID_RXTF)	|| \
																	((IT) == HSPIS_IT_ID_RXE)	|| ((IT) == HSPIS_IT_ID_TXF)	|| \
																	((IT) == HSPIS_IT_ID_TXE)	|| ((IT) == HSPIS_IT_ID_TXTF))
/**
  * @}
  */ 
  
/** @defgroup HSPIS_flags_definition 
  * @{
  */
...
#define HSPIS_FLAG_TXOVFERR											((uint32_t)0x0008)
#define HSPIS_FLAG_TXUDFERR											((uint32_t)0x0001)

#define HSPIS_FLAG_RXE												((uint32_t)0x0400)
#define HSPIS_FLAG_RXF												((uint32_t)0x1000)
#define HSPIS_FLAG_RXTF												((uint32_t)0x2000)
#define HSPIS_FLAG_RXOVFERR											((uint32_t)0x0800)
#define HSPIS_FLAG_RXUDFERR											((uint32_t)0x0100)
	
#define IS_HSPIS_GET_FLAG(FLAG) 									(((FLAG) == HSPIS_FLAG_TXE)     || ((FLAG) == HSPIS_FLAG_TXF)       || \
																	((FLAG) == HSPIS_FLAG_TXTF)     || ((FLAG) == HSPIS_FLAG_TXOVFERR)  || \
																	((FLAG) == HSPIS_FLAG_TXUDFERR) || ((FLAG) == HSPIS_FLAG_RXE)       || \
																	((FLAG) == HSPIS_FLAG_RXF)      || ((FLAG) == HSPIS_FLAG_RXTF)      || \
																	((FLAG) == HSPIS_FLAG_RXOVFERR) || ((FLAG) == HSPIS_FLAG_RXUDFERR)) 
/**
  * @}
  */ 
