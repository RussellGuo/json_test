...
void DCMI_Init(DCMI_InitTypeDef* DCMI_InitStruct)
{
    ...
    assert_param(IS_DCMI_DMAREQUESTFIFO_SIZE(DCMI_InitStruct->DCMI_DMARequestSize));
    SYSCTRL->DBG_CR |= DCMI_Input_Mode_DVP;
    ...
    reg |= DCMI_InitStruct->DCMI_CaptureMode |      //
           ...
           DCMI_InitStruct->DCMI_DMARequestSize;
...
void DCMI_StructInit(DCMI_InitTypeDef* DCMI_InitStruct)
{
    ...
    DCMI_InitStruct->DCMI_DMARequestSize   = DCMI_DMARequestFIFOSize_4Word;
    DCMI_InitStruct->DCMI_InputMode        = DCMI_Input_Mode_DVP;
}
...
/************************ (C) COPYRIGHT 2018 Megahuntmicro ****END OF FILE****/
