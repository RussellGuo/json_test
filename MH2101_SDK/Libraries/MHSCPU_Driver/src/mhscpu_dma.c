...
void DMA_Init(DMA_TypeDef* DMA_Channelx, DMA_InitTypeDef* DMA_InitStruct) {
    ...
    if ((DMA->RawBlock_L & tmpChannelxBit) | (DMA->RawDstTran_L & tmpChannelxBit) | (DMA->RawErr_L & tmpChannelxBit) | (DMA->RawSrcTran_L & tmpChannelxBit) |
        (DMA->RawTfr_L & tmpChannelxBit) | (DMA->StatusBlock_L & tmpChannelxBit) | (DMA->StatusDstTran_L & tmpChannelxBit) |
        (DMA->StatusErr_L & tmpChannelxBit) | (DMA->StatusSrcTran_L & tmpChannelxBit) | (DMA->StatusTfr_L & tmpChannelxBit))
        return;
    ...
    if (DMA_DIR_Peripheral_To_Memory == DMA_DIR) {
        switch (DMA_Peripheral) {
            ...
            case SPIM0_BASE:
                ...
                break;
            case HSPIM1_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI1_RX;
                break;
            case HSPIS1_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI1_RX;
                break;
            case SPIM2_BASE:
                ...
                break;
            case HSPIM0_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI0_RX;
                break;
            case HSPIS0_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI0_RX;
                break;
        ...
        switch (DMA_Peripheral) {
            ...
            case SPIM0_BASE:
                ...
                break;
            case HSPIM1_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI1_TX;
                break;
            case HSPIS1_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI1_TX;
                break;
            case SPIM2_BASE:
                ...
                break;
            case HSPIM0_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI0_TX;
                break;
            case HSPIS0_BASE:
                tmpDMA_CHx_IFx = SYSCTRL_PHER_CTRL_DMA_CHx_IF_HSPI0_TX;
                break;
