...
typedef enum {
    ...
    CAMERA_IOCTRL_SET_SHUTTER_VAL,
    CAMERA_IOCTRL_GET_SHUTTER_VAL,
    CAMERA_IOCTRL_SET_CONTRAST_VAL,
    CAMERA_IOCTRL_GET_CONTRAST_VAL,
    CAMERA_IOCTRL_SET_GAIN_VAL,
    CAMERA_IOCTRL_GET_GAIN_VAL,
