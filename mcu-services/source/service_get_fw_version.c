...
#define __SAIP_VERSION_DATE_IDX 0
#define __SAIP_FW_VERSION_IDX   1
extern const uint32_t __SAIP_MCU_VERSION[2];


// ReplyToReqFwVersion, the function is in the API layer of the host-MCU communication
...
//   [out] VersionDate, FwVersion, the ptr to the return values
...
void ReplyToReqFwVersion(res_error_code_t *error_code, uint32_t *VersionDate, uint32_t *FwVersion, serial_datagram_item_t seq)
{
    ...
    *VersionDate = __SAIP_MCU_VERSION[__SAIP_VERSION_DATE_IDX];
