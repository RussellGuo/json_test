...
int main(void) {
    ...
    const unsigned char to_mcu_buf[] = {0x08, 0x01, 0x1a, 0x10, 0x0a, 0x07, 0x52, 0x75, 0x73, 0x73, 0x65, 0x6c, 0x6c, 0x12, 0x05, 0x31, 0x32, 0x33, 0x34, 0x35};
    ...
    const unsigned char expected_from_mcu_binary[] = {0x08, 0x02, 0x10, 0x04, 0x1a, 0x02, 0x08, 0x02};
    assert(status);
